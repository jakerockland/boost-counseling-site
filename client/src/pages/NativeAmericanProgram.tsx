...
export default function NativeAmericanProgram() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="py-12 md:py-20">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8 md:gap-12">
            <div>
              <h2 className="font-serif text-3xl font-bold text-foreground mb-6">Mission Statement</h2>
            ...
            <div>
              <h2 className="font-serif text-3xl font-bold text-foreground mb-6">Program Philosophy</h2>
              <p className="text-lg text-muted-foreground leading-relaxed">
      ...
      <section className="py-12 md:py-20 bg-muted/30" id="program-details">
        <div className="container mx-auto px-4">
          <h2 className="font-serif text-2xl sm:text-3xl font-bold text-center mb-8 md:mb-12">Core Treatment Tracks</h2>
      ...
      <section className="py-12 md:py-20">
        <div className="container mx-auto px-4">
          <h2 className="font-serif text-2xl sm:text-3xl font-bold text-center mb-8 md:mb-12">Holistic and Traditional Modalities</h2>
      ...
      <section className="py-12 md:py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <h2 className="font-serif text-2xl sm:text-3xl font-bold text-center mb-8 md:mb-12">Program Structure</h2>
          <div className="grid md:grid-cols-3 gap-6 md:gap-8 max-w-5xl mx-auto">
            <Card className="border-none shadow-lg bg-white/50">
              <CardContent className="p-5 sm:p-8">
                <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center mb-4">
      ...
      <section className="py-12 md:py-20">
        <div className="container mx-auto px-4">
          <h2 className="font-serif text-2xl sm:text-3xl font-bold text-center mb-8 md:mb-12">Core Pillars of Healing</h2>
      ...
      <section className="py-12 md:py-20 bg-muted/30">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="font-serif text-2xl sm:text-3xl font-bold text-center mb-4">Clinical and Traditional Services</h2>
      ...
      <section className="py-12 md:py-20">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="font-serif text-2xl sm:text-3xl font-bold text-center mb-8 md:mb-12">General Outpatient Program (OP)</h2>
      ...
      {/* CTA */}
      <section className="py-12 md:py-20 bg-primary text-white relative overflow-hidden text-center">
        <div className="container mx-auto px-4">
          <h2 className="font-serif text-2xl sm:text-3xl font-bold mb-6">Begin Your Healing Journey</h2>
